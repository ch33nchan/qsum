#!/usr/bin/env python3
"""
Rigorous CPU Experiments with Proper Statistical Analysis
Fixes the flawed reporting and provides accurate data-driven conclusions
"""
...
class RigorousCPUExperiments:
    ...
    def run_comprehensive_ablation_study(self, num_trials: int = 10, scenarios_per_trial: int = 100) -> Dict[str, Any]:
    ...
    def run_optimal_hyperparameter_study(self, num_trials: int = 3) -> Dict[str, Any]:
        ...
        # Based on previous results, test around num_strategies=4
        param_combinations = [
            {'num_strategies': 4, 'lambda_commitment': 0.0, 'lambda_deception': 0.1},  # Best from previous
            {'num_strategies': 4, 'lambda_commitment': 0.1, 'lambda_deception': 0.1},
            {'num_strategies': 4, 'lambda_commitment': 0.3, 'lambda_deception': 0.1},
            {'num_strategies': 6, 'lambda_commitment': 0.0, 'lambda_deception': 0.1},
            {'num_strategies': 6, 'lambda_commitment': 0.1, 'lambda_deception': 0.05},
        ]
    ...
    def run_all_experiments(self) -> Dict[str, Any]:
        ...
        logger.info("=== Starting Rigorous CPU Experiments ===")
        ...
        logger.info("\n--- Running Optimal Hyperparameter Study ---")
        ...
        # Save results
        results_file = self.results_dir / f"rigorous_cpu_experiments_{int(time.time())}.json"
        with open(results_file, 'w') as f:
            json.dump(self.results, f, indent=2, default=self._json_serializer)
        
        logger.info(f"\n=== Rigorous CPU Experiments Complete ===")
...
def run_cpu_experiments():
    """Main function to run rigorous CPU experiments"""
...
if __name__ == "__main__":
    ...
    print("\nRigorous CPU Experiments Summary:")
